      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-12 text-center">
            <a data-theme-color="#6234AC" href="blog.html" className="category">{post.category}</a>
            <h2 className="blog-title">{post.title}</h2>
            <div className="blog-meta">
              <a className="author" href="author.html"><i className="far fa-user"></i>By - {post.author}</a>
              <a href="blog.html"><i className="fal fa-calendar-days"></i>{post.date}</a>
              <a href="blog-details.html"><i className="far fa-comments"></i>Comments ({post.comments.length})</a>
              <span><i className="far fa-book-open"></i>{post.readingTime} Mins Read</span>
            </div>
            <div className="blog-img mb-40">
              <Image src={post.mainImage} alt="Blog Image" />
            </div>
          </div>
              ...
              <div className="blog-content-wrap">
                ...
                <div className="blog-content">
                  ...
                  <div className="content">
                    {post.introduction.map((text, index) => (
                      <p key={`introduction-${index}`}>{text}</p>
                    ))}
